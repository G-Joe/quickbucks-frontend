      ...
      <div className="edit-details">
        <div className="form-wrapper">
          <form className="otp-open-account">
            <h3>
              A One Time Passwword(OTP) has been sent to <br />
              your BVN regsitered phone number or email
              <br />
              <span className="otp-num">+234813****35</span> or{" "}
              <span className="otp-num">ero@****@gmail.com</span>
            </h3>
            <Input
              label="OTP"
              type="text"
